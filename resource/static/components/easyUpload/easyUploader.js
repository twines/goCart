    ...
    easyUploader.prototype = {
        ...
        updateFilesDom: function () {
            ...
            this.files.forEach(function (fileItem, index) {
                ...
                if (fileItem.ajaxResponse != undefined) {
                    html += '<input name="img[]" type="hidden" value="' + fileItem.ajaxResponse.data
                    html += '"/>'
                }
                html += '<div class="preview">'
                    + '<img class="preview-img img-responsive" src="' + fileItem.previewBase + '" />'
                    + '</div>'
                    + '<div class="info">'
                    + '<p class="filename">'
                    + fileItem.file.name
